...
@section('title', 'Edit Upcoming TVShow')
                ...
                <div class="custom-border-card">
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-group">
                                <input type="text" name="name" id="Imdb_name" list="Imdb_name_list" class="form-control" value="{{$result->name}}" placeholder="Enter TV Show Name">
    ...
    <script>
        function edit_TVShow() {
            ...
            if(Check_Admin == 1){
                ...
                $.ajax({
                    type: 'POST',
                    url: '{{ route("upcomingtvshowUpdate") }}',
                    data: formData,
                    cache: false,
                    contentType: false,
                    processData: false,
                    success: function(resp) {
                        $("#dvloader").hide();
                        get_responce_message(resp, 'edit_TVShow', '{{ route("upcomingTVShow") }}');
                    },
